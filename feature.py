...
def GoogleSearch(term):
    ...
    # oooooo = open('D:\\AI\\Data.txt','a')
    oooooo = open('D:\\jarvis\\Data.txt','a')
    ...
    # os.startfile('D:\\AI\\Database\\ExtraPro\\start.py')
    os.startfile('D:\\jarvis\\Database\\ExtraPro\\start.py')
...
def Alarm(query):
    ...
    # TimeHere=  open('D:\\AI\\Data.txt','a')
    TimeHere=  open('D:\\jarvis\\Data.txt','a')
    TimeHere.write(query)
    TimeHere.close()
    # os.startfile("D:\\AI\\Database\\ExtraPro\\Alarm.py")
    os.startfile("D:\\jarvis\\Database\\ExtraPro\\Alarm.py")
...
def DownloadYouTube():
    ...
    def Download(link):
        ...
        # video.download('D:\\AI\\Database\\YouTube\\')
        video.download('D:\\jarvis\\Database\\YouTube\\')
    ...
    # os.startfile('D:\\AI\\Database\\YouTube\\')
    os.startfile('D:\\jarvis\\Database\\YouTube\\')


def SpeedTest():

    # os.startfile("D:\\AI\\Database\\Gui Programs\\speedtestgui.py")
    os.startfile("D:\\jarvis\\Database\\Gui Programs\\speedtestgui.py")
