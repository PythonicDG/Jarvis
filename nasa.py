...
def NasaNews(Date):
    ...
    # Path_1 = "D:\\AI\\" + str(FileName)
    Path_1 = "D:\\jarvis\\" + str(FileName)

    # Path_2 = "D:\\AI\\Database\\NasaDataBase\\" + str(FileName)
    Path_2 = "D:\\jarvis\\Database\\NasaDataBase\\" + str(FileName)
...
def Summary(Boby):
    ...
    # path = "D:\\AI\\Database\\NasaDataBase\\Images Used\\" + str(value) + ".jpg"
    path = "D:\jarvis\jarvis\Database\NasaDataBase\Images Used" + str(value) + ".jpg"
...
def MarsImage():
    ...
    try:
        ...
        for index , photo in enumerate(Photos):
            ...
            # Path_2 = "D:\\AI\\Database\\NasaDataBase\\MarsImage\\" + str(img)
            Path_2 = "D:\\jarvis\\Database\\NasaDataBase\\MarsImage\\" + str(img)
